...
//show the content
	...
	if ($action == "update") {
		echo "  <input type='button' class='btn' value='View' onclick=\"document.location.href='".PROJECT_PATH."/mod/call_center_active/v_call_center_active.php?queue_name=$queue_name';\" />\n";
