<?php
	...
	// CREATE TABLE v_call_center_logs 
		...
		$apps[$x]['db'][1]['fields'][10]['name'] = 'cc_caller_uuid';
		$apps[$x]['db'][1]['fields'][10]['type'] = 'text';
		$apps[$x]['db'][1]['fields'][10]['description'] = '';
		$apps[$x]['db'][1]['fields'][11]['name'] = 'cc_caller_cid_name';
		$apps[$x]['db'][1]['fields'][11]['type'] = 'text';
		$apps[$x]['db'][1]['fields'][11]['description'] = '';
		$apps[$x]['db'][1]['fields'][12]['name'] = 'cc_caller_cid_number';
		$apps[$x]['db'][1]['fields'][12]['type'] = 'text';
		$apps[$x]['db'][1]['fields'][12]['description'] = '';
		$apps[$x]['db'][1]['fields'][13]['name'] = 'cc_selection';
		$apps[$x]['db'][1]['fields'][13]['type'] = 'text';
		$apps[$x]['db'][1]['fields'][13]['description'] = '';
		$apps[$x]['db'][1]['fields'][14]['name'] = 'cc_cause';
		$apps[$x]['db'][1]['fields'][14]['type'] = 'text';
		$apps[$x]['db'][1]['fields'][14]['description'] = '';
		$apps[$x]['db'][1]['fields'][15]['name'] = 'cc_agent_answer_time';
		$apps[$x]['db'][1]['fields'][15]['type'] = 'text';
		$apps[$x]['db'][1]['fields'][15]['description'] = '';
		$apps[$x]['db'][1]['fields'][16]['name'] = 'cc_wait_time';
		$apps[$x]['db'][1]['fields'][16]['type'] = 'text';
		$apps[$x]['db'][1]['fields'][16]['description'] = '';
		$apps[$x]['db'][1]['fields'][17]['name'] = 'cc_talk_time';
		$apps[$x]['db'][1]['fields'][17]['type'] = 'text';
		$apps[$x]['db'][1]['fields'][17]['description'] = '';
		$apps[$x]['db'][1]['fields'][18]['name'] = 'cc_total_time';
		$apps[$x]['db'][1]['fields'][18]['type'] = 'text';
		$apps[$x]['db'][1]['fields'][18]['description'] = '';
		$apps[$x]['db'][1]['fields'][19]['name'] = 'cc_epoch';
		$apps[$x]['db'][1]['fields'][19]['type'] = 'numeric';
		$apps[$x]['db'][1]['fields'][19]['description'] = '';
		$apps[$x]['db'][1]['fields'][20]['name'] = 'cc_date';
		$apps[$x]['db'][1]['fields'][20]['type'] = 'timestamp without time zone';
		$apps[$x]['db'][1]['fields'][20]['description'] = '';
		$apps[$x]['db'][1]['fields'][21]['name'] = 'cc_agent_type';
		$apps[$x]['db'][1]['fields'][21]['type'] = 'text';
		$apps[$x]['db'][1]['fields'][21]['description'] = '';
		$apps[$x]['db'][1]['fields'][22]['name'] = 'cc_member_uuid';
		$apps[$x]['db'][1]['fields'][22]['type'] = 'text';
		$apps[$x]['db'][1]['fields'][22]['description'] = '';
		$apps[$x]['db'][1]['fields'][23]['name'] = 'cc_member_session_uuid';
		$apps[$x]['db'][1]['fields'][23]['type'] = 'text';
		$apps[$x]['db'][1]['fields'][23]['description'] = '';
		$apps[$x]['db'][1]['fields'][24]['name'] = 'cc_member_cid_name';
		$apps[$x]['db'][1]['fields'][24]['type'] = 'text';
		$apps[$x]['db'][1]['fields'][24]['description'] = '';
		$apps[$x]['db'][1]['fields'][25]['name'] = 'cc_member_cid_number';
		$apps[$x]['db'][1]['fields'][25]['type'] = 'text';
		$apps[$x]['db'][1]['fields'][25]['description'] = '';
		$apps[$x]['db'][1]['fields'][26]['name'] = 'cc_agent_called_time';
		$apps[$x]['db'][1]['fields'][26]['type'] = 'numeric';
		$apps[$x]['db'][1]['fields'][26]['description'] = '';
		$apps[$x]['db'][1]['fields'][27]['name'] = 'cc_agent_answered_time';
		$apps[$x]['db'][1]['fields'][27]['type'] = 'numeric';
		$apps[$x]['db'][1]['fields'][27]['description'] = '';
		$apps[$x]['db'][1]['fields'][28]['name'] = 'cc_member_joined_time';
		$apps[$x]['db'][1]['fields'][28]['type'] = 'numeric';
		$apps[$x]['db'][1]['fields'][28]['description'] = '';
		$apps[$x]['db'][1]['fields'][29]['name'] = 'cc_member_leaving_time';
		$apps[$x]['db'][1]['fields'][29]['type'] = 'numeric';
		$apps[$x]['db'][1]['fields'][29]['description'] = '';
		$apps[$x]['db'][1]['fields'][30]['name'] = 'cc_bridge_terminated_time';
		$apps[$x]['db'][1]['fields'][30]['type'] = 'numeric';
		$apps[$x]['db'][1]['fields'][30]['description'] = '';
		$apps[$x]['db'][1]['fields'][31]['name'] = 'cc_hangup_cause';
		$apps[$x]['db'][1]['fields'][31]['type'] = 'text';
		$apps[$x]['db'][1]['fields'][31]['description'] = '';
