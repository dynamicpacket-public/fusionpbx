...
$order = $_GET["order"];
	...
	echo "<tr>\n";
	echo thorderby('profile_name', 'Profile Name', $orderby, $order);
	echo thorderby('profile_desc', 'Description', $orderby, $order);
	...
	if ($resultcount == 0) { //no results
		...
		foreach($result as $row) {
			//print_r( $row );
			echo "<tr >\n";
			echo "	<td valign='top' class='".$rowstyle[$c]."'>".$row[profile_name]."</td>\n";
			echo "	<td valign='top' class='".$rowstyle[$c]."'>".$row[profile_desc]."</td>\n";
