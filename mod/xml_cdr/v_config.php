<?php
	...
	//schema details
		...
		$apps[$x]['db'][0]['fields'][32]['name'] = 'recording_file';
		$apps[$x]['db'][0]['fields'][32]['type'] = 'text';
		$apps[$x]['db'][0]['fields'][32]['description'] = 'Indicates if a recording was made. If a recording exists set this value to true.';
		$apps[$x]['db'][0]['fields'][33]['name'] = 'leg';
		$apps[$x]['db'][0]['fields'][33]['type']['pgsql'] = 'char(1)';
		$apps[$x]['db'][0]['fields'][33]['type']['sqlite'] = 'text';
		$apps[$x]['db'][0]['fields'][33]['type']['mysql'] = 'char(1)';
		$apps[$x]['db'][0]['fields'][33]['description'] = 'The leg of the call a or b.';
		$apps[$x]['db'][0]['fields'][34]['name'] = 'pdd_ms';
		$apps[$x]['db'][0]['fields'][34]['type']['pgsql'] = 'numeric';
		$apps[$x]['db'][0]['fields'][34]['type']['sqlite'] = 'numeric';
		$apps[$x]['db'][0]['fields'][34]['type']['mysql'] = 'smallint';
		$apps[$x]['db'][0]['fields'][34]['description'] = 'Post Dial Delay (PDD) in miliseconds. Divide by 1000 for seconds.';
		$apps[$x]['db'][0]['fields'][35]['name'] = 'last_app';
		$apps[$x]['db'][0]['fields'][35]['type']['pgsql'] = 'char(9)';
		$apps[$x]['db'][0]['fields'][35]['type']['sqlite'] = 'text';
		$apps[$x]['db'][0]['fields'][35]['type']['mysql'] = 'varchar(9)';
		$apps[$x]['db'][0]['fields'][35]['description'] = 'Save the last application in the leg.';
		$apps[$x]['db'][0]['fields'][36]['name'] = 'sip_hangup_disposition';
		$apps[$x]['db'][0]['fields'][36]['type']['pgsql'] = 'char(11)';
		$apps[$x]['db'][0]['fields'][36]['type']['sqlite'] = 'text';
		$apps[$x]['db'][0]['fields'][36]['type']['mysql'] = 'varchar(11)';
		$apps[$x]['db'][0]['fields'][36]['description'] = 'Save who hung up or cancelled the leg.';
