	...
	//Add or update the database
		if ($_POST["persistformvar"] != "true") {
			if ($action == "add") {
				...
				require_once "includes/header.php";
				echo "<meta http-equiv=\"refresh\" content=\"2;url=v_call_forward_edit.php?id=".$dialplan_include_id."\">\n";
				echo "<div align='center'>\n";
				echo "Add Complete\n";
				echo "</div>\n";
				require_once "includes/footer.php";
...
if (count($_GET)>0 && $_POST["persistformvar"] != "true") {
	...
	echo "<tr>\n";
	if ($action == "add") {
		echo "<td align='left' width='30%' nowrap><b>Call Forward Detail Add</b></td>\n";
	}
	if ($action == "update") {
		echo "<td align='left' width='30%' nowrap><b>Call Forward Detail Update</b></td>\n";
	}
	echo "<td width='70%' align='right'><input type='button' class='btn' name='' alt='back' onclick=\"window.location='v_call_forward_edit.php?id=".$dialplan_include_id."'\" value='Back'></td>\n";
	echo "</tr>\n";
