...
if (count($_POST)>0 && strlen($_POST["persistformvar"]) == 0) {
	...
	//add or update the database
		if ($_POST["persistformvar"] != "true") {
			...
			if ($action == "update" && permission_exists('conferences_advanced_edit')) {
...
//show the content
	...
	echo "<td width='70%' align='right'><input type='button' class='btn' name='' alt='back' onclick=\"window.location='v_conferences_edit.php?id=".$dialplan_include_id."'\" value='Back'></td>\n";
	echo "</tr>\n";
